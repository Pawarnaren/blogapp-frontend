...
const Login = ({ isUserAuthenticated }) => {
  ...
  return (
        ...
        // Box is replacement for div in material ui
        <Component> 
            <Box>
                <Image src={imageURL} alt="login" />
                {
                    account === 'login' ?
                        <Wrapper>
                            <TextField variant='standard' value={login.username} onChange={(e) => {onValueChange(e)}} 
                                name='username' label='Enter username' />
                            <TextField variant='standard' value={login.password} onChange={(e) => {onValueChange(e)}} 
